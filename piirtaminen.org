...
** Piirtoikkunan pisteen koordinaatit
   ...
   p5.js-ohjelmointikielessä piirretään kuvioita ja animaatioita
   ...
   yhden kerran, kun ohjelma käynnistetään. Tähän riviin palataan tarkemmin 
   kappaleessa funktiot.
